...
public class S3ConfigLocal {
    ...
    public S3ConfigLocal() {
        ...
        createQueue(snsClient, s3InvoiceEventsTopicArn, sqsClient); //create Queue and subscribe it into Topic
    ...
    private AmazonS3 getAmazonS3() {
        //According to localstack rules, for S3, I need to create credentials using this way.
